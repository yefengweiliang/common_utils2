...
import com.utils.pojo.PageResult;
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (parameterObject instanceof PageVo) {
            ...
            if(pagevo.getSort() != null){
                 pageSql = sql + " limit " + pagevo.getLimit() + " , " + pagevo.getOffset() + " order by " + pagevo.getSort();
                if(pagevo.getOrder() != null){
                     pageSql = sql + " limit " + pagevo.getLimit() + " , " + pagevo.getOffset() + " order by " + pagevo.getSort() + pagevo.getOrder();
                }
            }else{
                 pageSql = sql + " limit " + pagevo.getLimit() + " , " + pagevo.getOffset();
